...
public class PreExamDAO {
    private static final String URL = "jdbc:h2:~/h2db/db_prac;Mode=PostgreSQL;AUTO_SERVER=TRUE;;MV_STORE=false"; //"jdbc:h2:~/h2db/db_prac;Mode=PostgreSQL;AUTO_SERVER=TRUE\"";
    private static final String USER_NAME = "b2231050";
    private static final String USER_PASS = "b2231050";
